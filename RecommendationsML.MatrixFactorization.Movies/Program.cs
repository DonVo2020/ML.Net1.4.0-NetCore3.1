...
using RecommendationsML.MatrixFactorization.Movies.DataStructures;
using System;
using System.IO;

namespace RecommendationsML.MatrixFactorization.Movies
{
    class Program
    {
        ...
        public static string DatasetsRelativePath = @"datasets";
