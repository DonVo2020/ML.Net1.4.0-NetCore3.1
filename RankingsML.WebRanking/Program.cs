using Microsoft.ML;
using RankingsML.WebRanking.DataStructures;
using System;
...
namespace RankingsML.WebRanking
{
    class Program
    {
        ...
        static void ConsumeModel(MLContext mlContext, ITransformer model, string modelPath, IDataView data)
        {
            ...
            Helper.PrintScores(firstGroupPredictions);
        }
    }
}
