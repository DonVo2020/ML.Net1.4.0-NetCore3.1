using BinaryClassificationML.SpamDetection.MLDataStructures;
...
namespace BinaryClassificationML.SpamDetection
{
    class Program
    {
        private static string AppPath => Path.GetDirectoryName(Environment.GetCommandLineArgs()[0]);
        private static string DataDirectoryPath => Path.Combine(AppPath, "..", "..", "..", "datasets", "spamfolder");
        private static string TrainDataPath => Path.Combine(AppPath, "..", "..", "..", "datasets", "spamfolder", "SMSSpamCollection");
